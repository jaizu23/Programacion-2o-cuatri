package main.java.PEC1.sesion2.Ej2;
...

{
...

    {
        ...
        Calculador p1 = new Calculador(1,2000000,suma, lock);

        Calculador p2 = new Calculador(2000001,4000000,suma, lock);

        Calculador p3 = new Calculador(4000001,6000000,suma, lock);

        Calculador p4 = new Calculador(6000001,8000000,suma, lock);

        Calculador p5 = new Calculador(8000001,10000000,suma, lock);
